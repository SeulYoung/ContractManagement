!function (t, e) {
    ...
    return function () {
        ...
        this.ScrollReveal = function () {
            function n(i) {
                return window == this ? new n(i) : (e = this, e.tools = new t, e.tools.extend(e.defaults, i || {}), e.supported() || "undefined" != typeof console && null !== console && console.log("ScrollReveal is not supported in this browser."), e.store = {
                    elements: {},
                    containers: []
            ...
            function m(t) {
                function e() {
                    var e = c + a * s, i = f + l * s, n = m - a * s, d = p - l * s, u = r.y + t.config.viewOffset.top,
                        y = r.x + t.config.viewOffset.left, g = r.y - t.config.viewOffset.bottom + o.height,
                        w = r.x - t.config.viewOffset.right + o.width;
                    return g > e && n > u && i > y && w > d
                }
                ...
                var n = y(t.domEl), o = d(t.config.container), r = u(t.config.container), s = t.config.viewFactor,
                    a = n.height, l = n.width, c = n.top, f = n.left, m = c + a, p = f + l;
                return e() || i()
            }
