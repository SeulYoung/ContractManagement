# Generated by Django 2.1.4 on 2018-12-16 03:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='', verbose_name='type')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
            fields=[
                ('num', models.AutoField(max_length=20, primary_key=True, serialize=False, verbose_name='num')),
        ...
        migrations.CreateModel(
            name='Function',
            fields=[
                ('num', models.CharField(max_length=10, primary_key=True, serialize=False, verbose_name='num')),
        ...
        migrations.CreateModel(
            name='State',
            fields=[
                ('conName', models.CharField(max_length=40, primary_key=True, serialize=False, verbose_name='conName')),
                ('type', models.IntegerField(verbose_name='type')),
                ('time', models.DateField(verbose_name='time')),
            ],
        ),
